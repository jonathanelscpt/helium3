...
class PointTest(BrowserAT):
    ...
    def test_top_left(self):
        self.assert_is_in_range(Point(2, 3), Button("Button 1").top_left, delta=(0, 1))
    ...
    def assert_around(self, expected, actual, delta, msg=None):
        self.assertIn(actual, list(range(expected - delta, expected + delta + 1)), msg)

    def test_click_top_left(self):
        click(Button("Button 1").top_left)
        self.assert_result_is("Button 1 clicked at offset (0, 0).", offset_delta=(1, 1))
    ...
    def test_hover_top_left(self):
        ...
        self.assert_result_is("Button 1 hovered at offset (0, 0).", offset_delta=(1, 1))
