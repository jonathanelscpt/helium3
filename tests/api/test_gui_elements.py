# -*- coding: utf-8 -*-
from helium3 import (Button, CheckBox, ComboBox, Config, Image, Link, ListItem,
                     RadioButton, Text, TextField, click, find_all, select,
                     write)
...
class GUIElementsTest(BrowserAT):
    ...
    def test_text_field_to_right_of_text_field(self):
        self.assertFindsEltWithId(
            TextField(to_right_of=TextField("Required Text Field")), "inputTypeTel"
        )
