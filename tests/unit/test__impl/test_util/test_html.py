...
class GetEasilyReadableSnippetTest(TestCase):
    def test_no_tag(self):
        self.assertEqual("Hello World!", get_easily_readable_snippet("Hello World!"))
    ...
    def test_empty_tag_with_attributes(self):
        ...
        self.assertEqual(
            empty_tag_with_attrs, get_easily_readable_snippet(empty_tag_with_attrs)
        )
    ...
    def test_tag_with_long_content(self):
        ...
        self.assertEqual(
            "<body>...</body>", get_easily_readable_snippet(tag_with_long_content)
        )
...
class NormalizeWhitespaceTest(TestCase):
    ...
    def test_tag_with_spaces_around_inner_html(self):
        self.assertEqual(
            "<span>Hi there!</span>", normalize_whitespace("<span> Hi there! </span>")
        )
